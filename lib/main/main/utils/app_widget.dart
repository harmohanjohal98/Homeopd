//T5Widget for OtpPage,VisitHistory
...
//import 'package:flutter_app/main/utils/dots_indicator.dart';
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            ...
            //   },
            // ),
            //Center(child: text('', textColor: appStore.textPrimaryColor, fontSize: textSizeNormal, fontFamily: fontBold))
          ],
        ),
      ),
    );
