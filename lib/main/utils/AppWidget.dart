...
import 'package:flutter_app/main/models/ListModels.dart';
  ...
  return AppBar(
   ...
   leading: IconButton(icon:Icon(Icons.arrow_back_ios),onPressed: () {
     Navigator.of(context)
         .pushNamed(MWTabBarScreen1.routeName);
   },),
  );
}
...
Widget placeholderWidget() => Image.asset('assets/images/password.png',scale: 5,);
